...
listaDePeriodicos* insereEmListaDePeriodicos(listaDePeriodicos *ListaPeriodicos, listaDeAutores *ListaAutores , char* nomeProfessor,
	...
	{
		printf("ListaPeriodicos Nulo!\n");
		return NULL;
	}
	if (ListaAutores == NULL)
	{
		printf("ListaAutores Nulo!\n");
		return NULL;
	}
	if (nomeProfessor == NULL)
	{
		printf("nomeProfessor Nulo!\n");
		return NULL;
	}
	if (natureza == NULL)
	{
		printf("natureza Nulo!\n");
		return NULL;
	}
	if (tituloArtigo == NULL)
	{
		printf("tituloArtigo Nulo!\n");
		return NULL;
	}
	if (tituloPeriodico == NULL)
	{
		printf("tituloPeriodico Nulo!\n");
		return NULL;
	}
	if (idioma == NULL)
	{
	...
	{
		printf("paginaInicial Nulo!\n");
		return NULL;
	}
	if (paginaFinal == NULL)
	{
		printf("paginaFinal Nulo!\n");
		return NULL;
	}
	/***********************************************************************************/
...
listaDeEventos* insereEmListaDeEventos(listaDeEventos *ListaEventos, listaDeAutores *ListaAutores, char* nomeProfessor, char* nomeParaCitacao_Professor, 
	...
	if (nomeParaCitacao_Professor == NULL)
	{
		printf("nomeParaCitacao_Professor Nulo!\n");
		return NULL;
	}
	if (nomeEvento == NULL)
	{
		printf("nomeEvento Nulo!\n");
		return NULL;
	}
	if (proceedings == NULL)
	{
		printf("proceedings Nulo!\n");
		return NULL;
	}
	if (idioma == NULL)
	{
