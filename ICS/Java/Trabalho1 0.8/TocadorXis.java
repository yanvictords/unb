...
{                          
    ...
    final JButton botaoBPMAUMENTA = constroiBotao("+", 9);
        ...
        final JButton botaoPARTIDA = constroiBotao("Partida ->", 9);
    final JButton botaoMETAMENSAGENS = constroiBotao("^", 9);
    ...
    public TocadorXis()
        ...
        botaoMETAMENSAGENS.setEnabled(false);
           ...
           /* botaoABRIR.addActionListener(new ActionListener()
                    ...
                    { public void actionPerformed(ActionEvent e)
                      { bpm = tocar(botaoMOSTRADORcaminho.getText(),k, bpm);
                      }
                    });
            ...
            botaoBPMDIMINUI.addActionListener(new ActionListener()
                    { public void actionPerformed(ActionEvent e)
                      {bpm = alterabpm(bpm, 0);  //altera bpm
            ...
            botaoBPMAUMENTA.addActionListener(new ActionListener()
                    { public void actionPerformed(ActionEvent e)
                      {bpm = alterabpm(bpm, 1);  //alterabpm
                 
                      }

                    });
            botaoMETAMENSAGENS.addActionListener(new ActionListener()
                    { public void actionPerformed(ActionEvent e)
                      { metamensagens();
                      }
                    });  
            ...
            p3.add(botaoPARTIDA);
                p3.add(botaoDIMINUIMAISinstante);
            p3.add(botaoDIMINUIinstante);
                p3.add(botaoREDEFINEinstante);
                p3.add(botaoADICIONAinstante);
                p3.add(botaoADICIONAMAISinstante);
            p3.add(botaoANDAMENTO);
            p3.add(botaoBPMAUMENTA);
            p3.add(botaoBPMDIMINUI);
                p4.add(sliderPROGRESSOinstante);
                p4.add(botaoMOSTRADORinstante);
            p5.add(vol); 
                    p5.add(sliderVolume);
                    p5.add(botaoMOSTRADORvalorvolume);
                p6.add(botaoFORMULAcompasso); 
                p6.add(botaoMETRO);
                p6.add(botaoARMADURAtonalidade);    


                    //-----  BACKGROUND              
            botaoPARTIDA.setBackground(corARQ);
            botaoMETAMENSAGENS.setBackground(corOPR);
...
//------------------------- PLAY
    ...
    public float tocar(String caminho, int k, float bpm)
        {  
        ...
        Par fc;
            ...
            if(bpmflag==0){
                int resolucao = sequencia.getResolution();
                        ...
                        durtique       = (float)(sequencia.getMicrosecondLength()/1000000)/totaltiques;
         ...
         botaoBPMAUMENTA.setEnabled(true);
             botaoMETAMENSAGENS.setEnabled(true);
            }   
...
//------------------------- RETARDO
 ...
 //------------------------- METAMENSAGENS
    public void metamensagens()  //MOSTRANDO EVENTOS, TRILHA, COMPASSO, TONALIDADE, METRO E INSTANTE   
        {
    int y = 0;
...
//------------------------- ALTERAR BPM
    public float alterabpm(float bpm, int x){
        float bpm2;
        if(x==1){
            bpm2 = bpm+10;
            sequenciador.setTempoInBPM(bpm2);
            
        }else{
            bpm2 = bpm-10;
            sequenciador.setTempoInBPM(bpm2);
        }
        botaoANDAMENTO.setText(+Math.round(bpm2)+ " bpm");
        return bpm2;
    }
//------------------------- Redefinir
