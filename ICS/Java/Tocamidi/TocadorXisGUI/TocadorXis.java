...
{                          
    ...
    public class MetaMessagem extends JFrame{
        	private  int largura = 420;
	        private  int altura  = 310;
	        ...
	        ImageIcon logo      = null;
      		...
      		final JButton botaoMETRO = constroiBotao("Metro: ", 9);
      		final JButton botaoANDAMENTO = constroiBotao("Andamento: ", 9);
      		final JButton botaoARMADURAtonalidade = constroiBotao("Tom: ", 9);
      		final JButton botaoMOSTRADORduracao2 = constroiBotao("Dura\u00e7\u00e3o: ",9 );
	...
	public MetaMessagem()
		{
				...
				try{
                    ...
                    JPanel painelOPERACOES2 = new JPanel();
	
                    painelOPERACOES2.setLayout(new GridLayout(3,0));
                    painel.setLayout(new GridLayout(7,0));



                    t1.add(botaoFORMULAcompasso);                      
                    painelOPERACOES2.add(t1);
                    botaoFORMULAcompasso.setBackground(corARQ);

                    t2.add(botaoMETRO);                      
                    painelOPERACOES2.add(t2);
                    botaoMETRO.setBackground(corARQ);
                    
                    t3.add(botaoANDAMENTO);                      
                    painelOPERACOES2.add(t3);
                    botaoANDAMENTO.setBackground(corARQ);
                    
                    t4.add(botaoARMADURAtonalidade);                      
                    painelOPERACOES2.add(t4);
                    botaoARMADURAtonalidade.setBackground(corARQ);
                    
                    t5.add(botaoMOSTRADORduracao2);                      
                    painelOPERACOES2.add(t5);
                    botaoMOSTRADORduracao2.setBackground(corARQ);
     
                    painel.add(painelOPERACOES2);
                    painel.add(t1);                                     
                    painel.add(t2);                     
                    painel.add(t3);                     
                    painel.add(t4);                     
	...
	public TocadorXis()
        {  
            ...
            try{
                    ...
                    botaoABREeventos.addActionListener(new ActionListener()
                    { public void actionPerformed(ActionEvent e)
	                  {

	                  	MetaMessagem tocador = new MetaMessagem();
                      }
                    });                    
...
double t     = sequenciador.getMicrosecondPosition()/1000000;
