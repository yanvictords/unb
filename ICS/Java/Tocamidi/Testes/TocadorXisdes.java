...
{                          
    ...
    final JButton botaoDIMINUI1instante = constroiBotao("<", 9);
        final JButton botaoADICIONA1instante = constroiBotao(">", 9);
	...
	public TocadorXis()
        {  
            ...
            personalizarInterfaceUsuario();   
             ...
             ImageIcon logo   = new javax.swing.ImageIcon(getClass().getResource("cavalo.jpg"));
      ...
      botaoADICIONA1instante.addActionListener(new ActionListener(){ 
        public void actionPerformed(ActionEvent e){
        k=adicionar1(k); 
      ...
      botaoDIMINUI1instante.addActionListener(new ActionListener()
                    { public void actionPerformed(ActionEvent e)
                      {k=diminuir1(k);  
			...
			botaoREDEFINEinstante.addActionListener(new ActionListener()
                    ...
                    p5.add(botaoDIMINUIinstante);
			               p5.add(botaoDIMINUI1instante);
                    p5.add(botaoREDEFINEinstante);
                    p5.add(botaoADICIONA1instante);
                    ...
                    botaoADICIONA1instante.setBackground(corARQ);
                    ...
                    botaoDIMINUI1instante.setBackground(corARQ);
        ...
        {  
            ...
            {  
              	...
              	for(int i=0; i<trilhas.length; i++)
              {
                ...
                {
                  botaoTRILHA.setText("Trilha nº: "+i+1);
                  ...
                  switch(n)
                  {
                      ...
                      case 255: nomecomando = "System_OFF"; break;
	...
	if(flag!=0)
		...
		sequenciador.setMicrosecondPosition(sec);
