...
#ifndef MODULO2_H_INST_INCLUDED
	#define MODULO2_H_INST_INCLUDED
...
listadeprojetosfinal*INST_INSERE_NA_LISTADEPROJETOSFINAL(listadeprojetosfinal*lista1,listaDeProjetos*lista2, listaDeAlunos*lista3,listaDeProfessores*lista4){ /*lista2=lista ja existente proveniente do modulo 1, lista2= lista de alunos ja existente, lista1=lista a ser criada*/
int conta,conta2,conta3,conta4;
		...
		/*----------------------Assertiva -------------------------------*/
			if(lista1==NULL){
				printf("Lista vazia recebida em insere_na_listadeprojetosfinal, ponteiro NULL para lista1\n");
			}
		/*----------------------------------------------------------------*/	
		...
		/*--------------assertiva-----------------------------*/
		if(temp10==NULL){
			printf("Lista de professores recebida em insere_na_listadeprojetosfinal vazia\n");
		}
		/*-------------------------------------------------------*/
		...
		/*------------------assertiva-------------__*/
		if(temp12==NULL){
			printf("lista de alunos recebida pela funcao insere_na_listadeprojetosfinal esta vazia\n");
		}
		/*------------------------------------------*/
		if(temp100==NULL){
			printf("lista de professores recebida pela funcao  insere_na_listadeprojetosfinal esta vazia\n");
		}
		/*------------------------------------------*/
			...
			if((conta2==0)&&(conta4==0)){/*se for 0 eh pq o nome nao foi encontrado na lista de alunos e nem de professores, entao eh um aluno externo*/				
				...
				/*--------------------assertiva-------------*/
				if(lista1==NULL){
					printf("Erro na funcao insere_na_listadeprojetosfinal, lista retornada esta vazia");
					return 0;
				}
				/*-----------------------------------*/
			return lista1;
...
listaDeEventosFinal*INST_insereNaListadeEventosFinal(listaDeEventosFinal*lista1,listaDeEventos*lista2, listaDeAlunos*lista3,listaDeProfessores*lista4){ /*lista2=lista ja existente proveniente do modulo 1, lista2= lista de alunos ja existente, lista1=lista a ser criada*/
int conta,conta2,conta3,conta4;
		...
		/*----------------------Assertiva -------------------------------*/
			if(lista1==NULL){
				printf("Lista vazia recebida em insereNaListadeEventosFinal, ponteiro NULL para lista1\n");
			}
		/*----------------------------------------------------------------*/	
		...
		/*------------assertiva------------------_*/
		if(temp1==NULL){
			printf("lista de alunos recebida pela funcao insereNaListadeEventosFinal esta vazia\n");
		}
		/*------------------------------------------*/
		if(temp10==NULL){
			printf("lista de professores recebida pela funcao insereNaListadeEventosFinal esta vazia\n");
		}
		/*---------------------------------------*/
			...
			/*----------------------Assertiva -------------------------------*/
			if(lista1==NULL){
					printf("Erro na funcao insereNaListaDeEventosFinal, lista retornada esta vazia");
					return 0;
				}
			/*---------------------------------------------------------------*/
...
/*!
* \brief Funcao que manipula e cria a lista de periodicoss final
...
listaDePeriodicosFinal*INST_insereNaListadePeriodicosFinal(listaDePeriodicosFinal*lista1,listaDePeriodicos*lista2, listaDeAlunos*lista3,listaDeProfessores*lista4){ /*lista2=lista ja existente proveniente do modulo 1, lista2= lista de alunos ja existente, lista1=lista a ser criada*/
int conta,conta2,conta3,conta4;
		...
		/*----------------------Assertiva -------------------------------*/
			if(lista1==NULL){
				printf("Lista vazia recebida em insereNaListaDePeriodicosFinal, ponteiro NULL para lista1\n");
			}
		/*----------------------------------------------------------------*/	
		...
		while(lista2->autores!=NULL){  /*while que garante que todos os nodos contendo os nomes dos autores da lista2->autores sejam verificados*/
			...
			/*------------assertiva------------------_*/
		if(temp1==NULL){
			printf("lista de alunos recebida pela funcao insereNaListaDePeriodicossFinal esta vazia\n");
		}
		/*------------------------------------------*/
		if(temp10==NULL){
			printf("lista de professores recebida pela funcao insereNaListadePeriodicosFinal esta vazia\n");
		}
		/*---------------------------------------*/
			...
			/*----------------------Assertiva -------------------------------*/
			if(lista1==NULL){
					printf("Erro na funcao insereNaListaDePeriodicosFinal, lista retornada esta vazia");
					return 0;
				}
			/*---------------------------------------------------------------*/	
		printf("FUNFOU2");
